    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                if (isMounted) setError('Could not load access details. Please try again.');
            } finally {
    ...
    return (
        <div className="max-w-screen-xl mx-auto px-6 py-8 font-geist text-gray-900">
            ...
            <div className="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold tracking-tight">Temporary Access</h1>
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden min-h-[400px] flex flex-col">
                <div className="px-6 py-4 border-b border-gray-100 bg-gray-50/50 flex justify-between items-center">
                    <h2 className="text-xs font-bold text-gray-400 uppercase tracking-widest">Access History</h2>
                </div>
                ...
                {isLoading && overrides.length === 0 ? (
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center p-16 text-center">
                        ...
                        <p className="text-sm font-medium">No Temporary Access Found</p>
                        <p className="text-xs text-gray-500 mt-1">No temporary access has been granted yet.</p>
                    </div>
                ) : (
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-gray-100 bg-white">
                                    ...
                                    <th className="px-6 py-4 text-[10px] font-bold text-gray-400 uppercase tracking-widest whitespace-nowrap">Temporary Role</th>
                                    <th className="px-6 py-4 text-[10px] font-bold text-gray-400 uppercase tracking-widest whitespace-nowrap">Reason & Approved By</th>
                                    <th className="px-6 py-4 text-[10px] font-bold text-gray-400 uppercase tracking-widest whitespace-nowrap">Access Until</th>
                                    ...
                                    return (
                                        <tr key={override.id} className="hover:bg-gray-50/50 transition group">
                                            ...
                                            <td className="px-6 py-4">
                                                ...
                                                <p className="text-[10px] text-gray-500 mt-0.5">Approved By: {override.granted_by_name}</p>
                                            </td>
                                            ...
                                            <td className="px-6 py-4">
                                                {isActive ? (
                                                    ...
                                                    <span className="flex items-center text-xs font-semibold text-gray-400">
                                                        ...
                                                        {isExpired ? 'EXPIRED' : 'ACCESS REMOVED'}
                                                    </span>
                                                )}
                                            </td>
