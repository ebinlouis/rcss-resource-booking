...
const NAV_LINKS = [
    ...
    { to: '/admin/vehicles',       label: 'Vehicle Management',      end: false, capability: (c) => c?.can_manage_fleet },
...
const NAV_ICONS = {
    ...
    'Vehicle Management':      'M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4',
...
const SidebarContent = ({ roleTitle, roleSubtitle, visibleLinks, collapsed, onCloseMobile, onNavigate, onLogout }) => (
    <>
        {/* Logo / Brand */}
        <div className={`border-b border-[#e8f5ee] transition-all duration-300 flex items-center ${collapsed ? 'justify-center px-3 h-16' : 'px-5 h-16'}`}>
            {collapsed ? (
...
const AdminLayout = () => {
    ...
    return (
        <div className="flex h-screen bg-[#f6fbf8] w-full" style={{ fontFamily: "'Geist', system-ui, sans-serif" }}>

            {/* Desktop Sidebar */}
            <aside className={`shrink-0 bg-white border-r border-[#e8f5ee] hidden md:flex flex-col z-20 transition-all duration-300 overflow-hidden ${sidebarCollapsed ? 'w-[64px]' : 'w-[230px]'}`}>
                    ...
                    <div className="flex items-center gap-2.5">
                        ...
                        <div className="relative" ref={profileRef}>
                            <button
                                ...
                                className="w-10 h-10 rounded-full overflow-hidden flex items-center justify-center text-white text-[14px] font-bold hover:opacity-90 active:scale-95 transition-all duration-150 ring-2 ring-[#d1fae5] ring-offset-1"
