...
<div className="bg-white/10 rounded-xl p-4 border border-white/10">
  <p className="text-[10px] text-green-300 uppercase font-semibold tracking-wider mb-2.5">
    Event Timing
  </p>
  ...
  <div className="space-y-2.5">
    <div className="flex items-center gap-2.5">
      ...
      <div>
        <p className="text-[10px] text-green-300/70 uppercase font-semibold mb-0.5">
          Starts
        </p>
...
{needsBuffer && (
  <div className="bg-white/10 rounded-xl p-4 border border-yellow-400/20">
    <p className="text-[10px] text-yellow-300 uppercase font-semibold tracking-wider mb-2.5 flex items-center gap-1.5">
...
{/* Approval card */}
<div className="bg-white/10 rounded-xl p-4 border border-white/10">
  <p className="text-[10px] text-green-300 uppercase font-semibold tracking-wider mb-1">
    Approval
  </p>
...
<div className="p-3 bg-yellow-50 border border-yellow-200 text-yellow-800 text-sm rounded-xl font-medium flex items-start gap-2">
                  <AlertTriangle className="w-4 h-4 mt-0.5 shrink-0" />
...
className={`relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-700 focus:ring-offset-2 ${formData.is_external_event ? "bg-yellow-500" : "bg-gray-200"}`}
                >
