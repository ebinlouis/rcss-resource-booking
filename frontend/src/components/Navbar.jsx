...
function Navbar({ activeTab = "Spaces", onTabChange }) {
  ...
  />
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Notification bell */}
            <button className="hidden md:flex relative w-8 h-8 items-center justify-center rounded-lg hover:bg-gray-100 text-gray-500 transition">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                <path strokeLinecap="round" strokeLinejoin="round"
                  d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118
                     ...
                     3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714
            ...
            <div className="relative" ref={profileRef}>
              ...
              >
                ...
                {/* Chevron */}
                <svg className={`hidden md:block w-3.5 h-3.5 text-gray-400 transition-transform ${profileOpen ? "rotate-180" : ""}`}
              ...
              {profileOpen && (
                <div className="absolute right-0 top-full mt-2 w-52 bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden z-50">
                  ...
                  <div className="py-1">
                    {[
                      { label: "My Bookings",   icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
      ...
      {/* ── Mobile dropdown ── */}
      <div className={`md:hidden border-t border-gray-100 bg-white transition-all duration-300 ease-in-out overflow-hidden
