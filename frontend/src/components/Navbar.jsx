                ...
                <div className="absolute right-0 top-full mt-2 w-56 bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden z-50">
                  ...
                  <div className="py-1">
                    {[
                      ...
                      effectiveRoles.includes('FACULTY') ? { label: "My Approvals", path: "/faculty-approvals", d: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" } : null,
                    ...
                    ].filter(Boolean).map(({ label, path, d }) => (
                      <Link
                        key={label}
                        to={path}
