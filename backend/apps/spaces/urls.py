...
from .views import SpaceViewSet, SpaceBookingViewSet, EquipmentViewSet, BlockViewSet, SpaceApproverViewSet, faculty_list, instructor_search
...
urlpatterns = [
    ...
    path('instructor-search/', instructor_search, name='instructor-search'),
